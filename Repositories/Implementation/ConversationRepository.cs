        ...
        public async Task<ResponseModel> GetAllConversation(int pageIndex, int pageSize)
        {
            ...
            var conversation = (from c in context.Conversations
                               ...
                               .Select(x => new ConversationDTO
                               {
                                   ...
                                   {
                                       Id = x.Key.User1Id,
                                       Avatar = x.Key.User1Avatar,
                                       FirstName = x.Key.User1FirstName,
                                       LastName = x.Key.User1LastName,
                                   },
                                   User2 = new()
                                   {
                                       Id = x.Key.User2Id,
                                       Avatar = x.Key.User2Avatar,
                                       FirstName = x.Key.User2FirstName,
                                       LastName = x.Key.User2LastName
                                   },
